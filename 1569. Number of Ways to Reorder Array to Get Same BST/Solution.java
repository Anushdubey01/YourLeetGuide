class Solution {
  ...
  private static final int kMod = 1_000_000_007;
   comb[n][k] = C(n, k)
  private ListListInteger comb;

  private int ways(ListInteger nums) {
    if (nums.size() = 2)
      return 1;

    ListInteger left = new ArrayList();
    ListInteger right = new ArrayList();
  ...
  public ListListInteger generate(int numRows) {
    ListListInteger comb = new ArrayList();
